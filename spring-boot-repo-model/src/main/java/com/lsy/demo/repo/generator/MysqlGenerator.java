package com.lsy.demo.repo.generator;
...
import com.lsy.demo.repo.generator.convert.MyConvert;
...
public class MysqlGenerator {
     ...
     * 配置文件路径
     */
    private static String configPath = "/spring-boot-repo-model/src/main/resources/config/generator.yaml";
